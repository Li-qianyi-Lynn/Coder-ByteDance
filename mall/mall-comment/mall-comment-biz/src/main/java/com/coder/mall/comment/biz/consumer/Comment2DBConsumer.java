package com.coder.mall.comment.biz.consumer;
...
import com.coder.mall.comment.biz.enums.CommentLevelEnum;
...
public class Comment2DBConsumer {
    ...
    public DefaultMQPushConsumer mqPushConsumer() throws MQClientException {
        // Group 组
        String group = "mall_group_" + MQConstants.TOPIC_PUBLISH_COMMENT;
            ...
            try {
                ...
                for (PublishCommentMqDTO publishCommentMqDTO : publishCommentMqDTOS) {
                    ...
                    CommentBO commentBO = CommentBO.builder()
                            ...
                            .productId(publishCommentMqDTO.getProductId())
                            ...
                            .parentId(publishCommentMqDTO.getProductId()) // 默认设置为所属商品 ID
                ...
                transactionTemplate.execute(status -> {
                    try {
                        ...
                        if (CollUtil.isNotEmpty(commentContentNotEmptyBOS)) {
                            ...
                            for (CommentBO commentBO : commentContentNotEmptyBOS) { // 更新子评论数
                                commentDOMapper.updateChildCommentTotal(commentBO.getParentId());
